      ...
      >
        ...
        <p>
          {leaving
            ...
            : `${captain.name}, your ${review?.ports.filter((p) => p.ownerId === playerId).length ?? 0} ports, ${review?.ships.filter((s) => s.ownerId === playerId).length ?? 0} ships, carried perks, and all construction will vanish. You cannot rejoin this match as a captain.`}
        </p>
